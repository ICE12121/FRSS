...
plot "data_wifi.txt" using 1:4 lw 6 lt 7 lc rgb "#A70D2A" with linespoints title 'WiFi', \
     "data_4G.txt" using 1:4 lw 6 lt 9 lc rgb "#00A36C" with linespoints title '4G'
set output